...
session_start();
  ...
  $strQry = "SELECT * FROM profesor WHERE id=$id;";
  		...
  		function enviar(opc){
  			switch(opc){
  				case 'upd':
  					...
  					document.getElementById('frmUpdProfesores').submit();
  				break;
  ...
  <body>
  	<form  name='frmUpdProfesores' id='frmUpdProfesores' action='./qryProfesores.php' method='POST'>
