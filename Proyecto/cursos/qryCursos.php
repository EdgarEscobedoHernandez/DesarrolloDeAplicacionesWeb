<?php
	...
	switch ($opcion) {
		...
		case 'add':
			...
			$strQry = "INSERT INTO curso ('id','nombre','especialidad','clave','semestre') VALUES ('$clave', '$nombre', '$especialidad','$clave','$semestre');";
		...
		case 'upd':
			...
			$clave = mysqli_real_escape_string($link, $_POST['txtClave']);
			$strQry = "DELETE FROM curso WHERE nombre ='$nombre';";
